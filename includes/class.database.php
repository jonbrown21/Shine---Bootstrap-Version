<?PHP
    class Database
    {
        ...
        // update mysqli connections do not return a resource
        // check for object instead
        ...
        {
            $result = $this->resulter($arg);
            return $this->hasRows($result) ? $this->createResult($result, 0, 0) : false;
        }
        ...
        {
            if(is_null($arg) && $this->result) {
                return $this->result;
            } elseif(is_object($arg) && $this->validateArgClass($arg)) {
                return $arg;
        ...
        private function createResult($res,$row=0,$col=0){ 
        ...
        private function validateArgClass($arg) {
            if (get_class($arg)=="mysqli_result"){
                return TRUE;
            }
            return FALSE;
        }
